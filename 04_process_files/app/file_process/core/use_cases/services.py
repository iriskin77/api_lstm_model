...
from app.configs.config import FILE_PATH_UPLOAD_TMP, FILE_PATH_DOWNLOAD_TMP
from app.file_process.repository.repository import FileRepository
...
class Service(ABC):
    ...
    @abstractmethod
    def add_file_to_bucket(self, user_uuid: str, file: File):
        raise NotImplementedError
...
class FileService(Service):
    ...
    async def add_file_to_bucket(self, user_uuid: str, file: File):
        ...
        res = await self._repo.create(bucket_name=user_uuid,
